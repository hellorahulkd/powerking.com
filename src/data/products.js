...
export const products = [
  ...
  /* ------------------------------------------------------------ Speakers --
   * Photographed on the shop floor in Kathmandu. Specifications are read off
   * each box; where a carton carries no brand or model number the field says
   * so rather than guessing one.
   * ---------------------------------------------------------------------- */
  {
    id: 201,
    name: 'PowerKing V35 Good Bass Solar Wireless Speaker',
    slug: 'powerking-v35-solar-speaker',
    brand: 'PowerKing',
    category: 'Speakers',
    description:
      'Solar-charging wireless speaker with a fold-out FM antenna, in the Good Bass line. Plays from Bluetooth, TF card or USB, and the solar panel tops the battery up outdoors.',
    image: '/images/products/powerking-v35-solar-speaker.jpg',
    gallery: [],
    packSize: '',
    unit: '',
    sku: 'V35',
    ...
    available: true,
    sample: false,
    tags: ['solar', 'fm radio', 'good bass', 'tf card', 'usb', 'powerking'],
  },
  {
    id: 202,
    name: 'PowerKing V9 Good Bass Wireless Speaker 8W x2',
    slug: 'powerking-v9-speaker',
    brand: 'PowerKing',
    category: 'Speakers',
    description:
      'Twin 8W drivers in the Good Bass line, with a moulded slot in the top that stands a phone up for video. Bluetooth, TF card, USB and FM.',
    image: '/images/products/powerking-v9-speaker.jpg',
    gallery: [],
    packSize: '',
    unit: '',
    sku: 'V9',
    ...
    available: true,
    sample: false,
    tags: ['8w', 'good bass', 'phone stand', 'fm radio', 'tf card', 'powerking'],
  },
  {
    id: 203,
    name: 'Kisonli U-2500BT 2.1 USB Gaming Speaker',
    slug: 'kisonli-u-2500bt-gaming-speaker',
    brand: 'Kisonli',
    category: 'Speakers',
    description:
      'A 2.1 desktop set for gaming — subwoofer with two satellites, Bluetooth, and an infrared remote in the box. USB powered.',
    image: '/images/products/kisonli-u-2500bt-gaming-speaker.jpg',
    gallery: [],
    packSize: '',
    unit: '',
    sku: 'U-2500BT',
    ...
    available: true,
    sample: false,
    tags: ['2.1', 'gaming', 'subwoofer', 'remote', 'bluetooth', 'desktop'],
  },
  {
    id: 204,
    name: 'Kisonli K19 20W Portable Speaker with RGB',
    slug: 'kisonli-k19-20w-speaker',
    brand: 'Kisonli',
    category: 'Speakers',
    description:
      '20W portable speaker with an RGB light band along the front and a moulded carry handle. Rated for splashes.',
    image: '/images/products/kisonli-k19-20w-speaker.jpg',
    gallery: [],
    packSize: '',
    unit: '',
    sku: 'K19',
    ...
    available: true,
    sample: false,
    tags: ['20w', 'rgb', 'portable', 'handle', 'tws'],
  },
  {
    id: 205,
    name: 'Kisonli SC-23 10W Speaker with Flashlight',
    slug: 'kisonli-sc-23-speaker',
    brand: 'Kisonli',
    category: 'Speakers',
    description:
      '10W portable speaker on a 1800mAh battery, with a built-in flashlight and a folding carry handle.',
    image: '/images/products/kisonli-sc-23-speaker.jpg',
    gallery: [],
    packSize: '',
    unit: '',
    sku: 'SC-23',
    ...
    available: true,
    sample: false,
    tags: ['10w', '1800mah', 'flashlight', 'portable', 'handle'],
  },
  {
    id: 206,
    name: 'Kisonli KS-1992 Music Portable Speaker',
    slug: 'kisonli-ks-1992-music-speaker',
    brand: 'Kisonli',
    category: 'Speakers',
    description:
      'Capsule-shaped stereo speaker with a phone stand moulded into the top. Bluetooth, AUX, TF card and USB, with a wrist strap.',
    image: '/images/products/kisonli-ks-1992-music-speaker.jpg',
    gallery: [],
    packSize: '',
    unit: '',
    sku: 'KS-1992',
    ...
    available: true,
    sample: false,
    tags: ['stereo', 'aux', 'tf card', 'usb', 'phone stand', 'strap'],
  },
  {
    id: 207,
    name: 'Kisonli Q2 Mini Music Speaker',
    slug: 'kisonli-q2-mini-speaker',
    brand: 'Kisonli',
    category: 'Speakers',
    description:
      'Compact mains-shaped mini speaker with a top carry handle — the counter-price entry in the Kisonli range.',
    image: '/images/products/kisonli-q2-mini-speaker.jpg',
    gallery: [],
    packSize: '',
    unit: '',
    sku: 'Q2',
    ...
    available: true,
    sample: false,
    tags: ['mini', 'portable', 'handle', 'entry'],
  },
  {
    id: 208,
    name: 'Kisonli B3 Solar Car Music Speaker',
    slug: 'kisonli-b3-solar-car-speaker',
    brand: 'Kisonli',
    category: 'Speakers',
    description:
      'SUV-shaped novelty speaker with a solar panel in the roof, stereo playback and a built-in flashlight. Sold as a gift line.',
    image: '/images/products/kisonli-b3-solar-car-speaker.jpg',
    gallery: [],
    packSize: '',
    unit: '',
    sku: 'B3',
    ...
    available: true,
    sample: false,
    tags: ['car speaker', 'solar', 'novelty', 'gift', 'flashlight', 'suv'],
  },
  {
    id: 209,
    name: 'Kisonli B2 Car Gift Speaker',
    slug: 'kisonli-b2-car-gift-speaker',
    brand: 'Kisonli',
    category: 'Speakers',
    description:
      'Off-roader-shaped speaker sold as a children\\u2019s gift line, with solar charging, stereo playback and a flashlight.',
    image: '/images/products/kisonli-b2-car-gift-speaker.jpg',
    gallery: [],
    packSize: '',
    unit: '',
    sku: 'B2',
    ...
    available: true,
    sample: false,
    tags: ['car speaker', 'solar', 'gift', 'children', 'flashlight', 'novelty'],
  },
  {
    id: 210,
    name: 'LP V78 Good Bass Solar Speaker 10W',
    slug: 'lp-v78-solar-speaker',
    brand: 'LP',
    category: 'Speakers',
    description:
      '10W solar-energy speaker with a 74cm telescopic antenna, side light and removable carry belt. FM radio, TF card and USB on a 1800mAh battery.',
    image: '/images/products/lp-v78-solar-speaker.jpg',
    gallery: [],
    packSize: '',
    unit: '',
    sku: 'V78',
    ...
    available: true,
    sample: false,
    tags: ['solar', '10w', 'fm radio', '74cm antenna', 'side light', '1800mah', 'good bass'],
  },
  {
    id: 211,
    name: 'LP V90 Good Bass Speaker 10W with RGB',
    slug: 'lp-v90-speaker',
    brand: 'LP',
    category: 'Speakers',
    description:
      '10W loud-stereo speaker built around a 4-inch driver, with an RGB light strip and a 74cm telescopic antenna. FM radio, USB, TF card, Type-C, 1800mAh.',
    image: '/images/products/lp-v90-speaker.jpg',
    gallery: [],
    packSize: '',
    unit: '',
    sku: 'V90',
    ...
    available: true,
    sample: false,
    tags: ['10w', '4 inch', 'rgb', 'fm radio', 'type c', '1800mah', 'good bass'],
  },
  {
    id: 212,
    name: 'LP V102 Good Bass Speaker 8W with RGB Ring',
    slug: 'lp-v102-speaker',
    brand: 'LP',
    category: 'Speakers',
    description:
      '8W loud-stereo speaker with a circular RGB ring on the face and a slot that stands a phone up. FM radio, Type-C, USB, TF card, 1200mAh, with a wrist strap.',
    image: '/images/products/lp-v102-speaker.jpg',
    gallery: [],
    packSize: '',
    unit: '',
    sku: 'V102',
    ...
    available: true,
    sample: false,
    tags: ['8w', 'rgb', 'phone stand', 'fm radio', 'type c', '1200mah', 'good bass'],
  },
  {
    id: 213,
    name: 'LP V86 Mini Good Bass Speaker 8W',
    slug: 'lp-v86-mini-speaker',
    brand: 'LP',
    category: 'Speakers',
    description:
      '8W loud-stereo mini speaker with an RGB light bar, phone stand and a 74cm telescopic antenna. FM radio, USB, TF card, Type-C, 1800mAh.',
    image: '/images/products/lp-v86-mini-speaker.jpg',
    gallery: [],
    packSize: '',
    unit: '',
    sku: 'V86 Mini',
    ...
    available: true,
    sample: false,
    tags: ['8w', 'mini', 'rgb', 'phone stand', 'fm radio', '74cm antenna', 'good bass'],
  },
  {
    id: 214,
    name: 'LP V80 Good Bass Speaker IPX4',
    slug: 'lp-v80-v81-ipx4-speaker',
    brand: 'LP',
    category: 'Speakers',
    description:
      'Compact splash-resistant speaker rated IPX4, with a clip loop for a bag or belt. Photographed alongside the LP V81; separate product shots are still to come.',
    image: '/images/products/lp-v80-v81-ipx4-speaker.jpg',
    gallery: [],
    packSize: '',
    unit: '',
    sku: 'V80',
    ...
    available: true,
    sample: false,
    tags: ['ipx4', 'splash resistant', 'compact', 'clip', 'good bass'],
  },
  {
    id: 215,
    name: 'J-iPOK P353 Rugged Portable Speaker',
    slug: 'j-ipok-p353-portable-speaker',
    brand: 'J-iPOK',
    category: 'Speakers',
    description:
      'Rugged red-and-black portable speaker with a moulded roll cage, top carry handle and a telescopic antenna.',
    image: '/images/products/j-ipok-p353-portable-speaker.jpg',
    gallery: [],
    packSize: '',
    unit: '',
    sku: 'P353',
    ...
    available: true,
    sample: false,
    tags: ['rugged', 'portable', 'handle', 'antenna', 'outdoor'],
  },
  {
    id: 216,
    name: 'J-iPOK P338 Car Bluetooth Speaker',
    slug: 'j-ipok-p338-car-speaker',
    brand: 'J-iPOK',
    category: 'Speakers',
    description:
      'Sedan-shaped Bluetooth speaker in the Supre Bass line, with a solar panel under the rear spoiler. A gift and counter-impulse line.',
    image: '/images/products/j-ipok-p338-car-speaker.jpg',
    gallery: [],
    packSize: '',
    unit: '',
    sku: 'P338',
    ...
    available: true,
    sample: false,
    tags: ['car speaker', 'novelty', 'solar', 'gift', 'bluetooth'],
  },
  {
    id: 217,
    name: 'WSJAR WS-105 6x6 Car Speaker',
    slug: 'wsjar-ws-105-car-speaker',
    brand: 'WSJAR',
    category: 'Speakers',
    description:
      'Six-wheel pickup-shaped Bluetooth speaker with a spare tyre on the bed. Plays from USB devices and TF cards.',
    image: '/images/products/wsjar-ws-105-car-speaker.jpg',
    gallery: [],
    packSize: '',
    unit: '',
    sku: 'WS-105',
    ...
    available: true,
    sample: false,
    tags: ['car speaker', 'novelty', 'usb', 'tf card', 'gift', 'pickup'],
  },
  {
    id: 218,
    name: 'BOOMSBOX3 Joyous Sound Wireless Speaker',
    slug: 'boomsbox3-joyous-sound-speaker',
    brand: '[CONFIRM BRAND]',
    category: 'Speakers',
    description:
      'Barrel-shaped Hi-Fi speaker with a moulded carry handle, TWS pairing to a second unit, a colour lamp and a 3000mAh battery.',
    image: '/images/products/boomsbox3-joyous-sound-speaker.jpg',
    gallery: [],
    packSize: '',
    unit: '',
    sku: 'BOOMSBOX3',
    ...
    available: true,
    sample: false,
    tags: ['tws', 'hi fi', '3000mah', 'handle', 'colour lamp', 'portable'],
  },
  {
    id: 219,
    name: 'NDR High-Power Outdoor Trolley Speaker',
    slug: 'ndr-high-power-outdoor-speaker',
    brand: 'NDR',
    category: 'Speakers',
    description:
      'High-power outdoor cabinet on a stand, supplied with wireless microphones. The box front states big voice, high power and a big battery; no model number is printed on it.',
    image: '/images/products/ndr-high-power-outdoor-speaker.jpg',
    gallery: [],
    packSize: '',
    unit: '',
    sku: '',
    ...
    available: true,
    sample: false,
    tags: ['outdoor', 'trolley', 'wireless mic', 'high power', 'party', 'stand'],
  },
  {
    id: 220,
    name: 'DPUS Wooden Cabinet Wireless Speaker',
    slug: 'dpus-wooden-trolley-speaker',
    brand: 'DPUS',
    category: 'Speakers',
    description:
      'Wood-finish cabinet speaker on a stand with a wired microphone input, AUX and USB inputs, FM radio and a remote control. No model number is printed on the unit.',
    image: '/images/products/dpus-wooden-trolley-speaker.jpg',
    gallery: [],
    packSize: '',
    unit: '',
    sku: '',
    ...
    available: true,
    sample: false,
    tags: ['wooden', 'cabinet', 'remote', 'fm radio', 'aux', 'mic input', 'stand'],
  },
  {
    id: 221,
    name: 'Colorful Karaoke Speaker Set with Two Microphones',
    slug: 'karaoke-speaker-two-mics',
    brand: '[CONFIRM BRAND]',
    category: 'Speakers',
    description:
      'Small karaoke set: one RGB-lit speaker on a leather carry strap with two wireless microphones. The box states a colourful karaoke sound system and carries no model number.',
    image: '/images/products/karaoke-speaker-two-mics.jpg',
    gallery: [],
    packSize: '',
    unit: '',
    sku: '',
    ...
    available: true,
    sample: false,
    tags: ['karaoke', 'microphone', 'rgb', 'portable', 'gift', 'party'],
  },
  {
    id: 222,
    name: 'V6 Wireless Speaker with Phone Stand',
    slug: 'v6-wireless-speaker',
    brand: '[CONFIRM BRAND]',
    category: 'Speakers',
    description:
      'Wireless speaker with a fold-up phone stand and a telescopic antenna. The carton is printed only with MODEL: V6 and shows no brand on its face.',
    image: '/images/products/v6-wireless-speaker.jpg',
    gallery: [],
    packSize: '',
    unit: '',
    sku: 'V6',
    ...
    available: true,
    sample: false,
    tags: ['phone stand', 'antenna', 'portable', 'wireless'],
  },
